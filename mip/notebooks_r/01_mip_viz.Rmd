...
# plot
p = ggplot(data=df, aes(x=session_time, y=indic_museum_pc, colour=indicator_code_merged, linetype=indicator_code_merged)) + geom_point() + geom_line() + theme_light() + ylim(0,100) + ggtitle('Indicators for all museums (%) with upper and lower boundaries based on evaluation accuracy')
